...
Private Sub LoadLV()
    ...
    '-- Students
    g_sSQL = "SELECT * FROM qryStudents WHERE AcadYR_Duration='" & CStr(cur_acadYear) & "' AND StudName LIKE '%" & CStr(Trim(txtText.Text)) & "%'"
    ...
    If Not rsTemp.EOF Or Not rsTemp.BOF Then
        ...
        Do While Not rsTemp.EOF
            On Error Resume Next
            Set itemToAdd = frmMain.lvListView.ListItems.Add(, , rsTemp!StudentID, , 1)
            ...
            itemToAdd.SubItems(9) = rsTemp!CPhone
            itemToAdd.SubItems(10) = rsTemp!MPhone
